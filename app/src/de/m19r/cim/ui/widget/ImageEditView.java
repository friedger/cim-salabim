...
public class ImageEditView extends SurfaceView implements
	...
	class ImageEditThread extends Thread {
		...
		public ImageEditThread(SurfaceHolder surfaceHolder, Context context,
				Handler handler) {
	...
	private ImageEditThread thread;
	...
	public ImageEditView(Context context, AttributeSet attrs) {
		...
		thread = new ImageEditThread(holder, context, new Handler() {
			@Override
	 ...
	 */
	public ImageEditThread getThread() {
		return thread;
	}
